...
var theBrowser = isOpera ? 'Opera' : isFirefox ? 'Firefox' : isSafari ? 'Safari' : isChrome ? 'Chrome' : isIE ? 'IE' : isEdge ? 'Edge' : "Unknown Browser";
...
if (browser !== 'Firefox') {
    // Firefox doesn't support collapsed console
...
var bgVideo = __webpack_require__(9);
bgVideo.init();
...
$(function () {
    ...
    $.get('/api/discord?cache=' + Date.now(), function (data) {
        ...
        data.members.forEach(function (member) {
            ...
            var username = member.nick ? member.nick : member.username;
...
var videoList = __webpack_require__(10);
...
var theVideo = {
    ...
    init: function init() {
        ...
        document.getElementById('playlists').querySelector('.close').addEventListener("click", function () {
            document.getElementById('playlists').classList.remove('open');
        });

        document.getElementById('intro').querySelector('.close').addEventListener("click", function () {
            document.getElementById('intro').classList.remove('show');
        });

        Array.from(document.getElementsByClassName('theaterModeToggle')).forEach(function (element) {
    ...
    loadVid: function loadVid(itoken) {
        ...
        var linkMarkup = '<a href="' + link + '" target="_blank" rel="noopener noreferrer" title="View original on ' + type + '">source</a>';
...
var videoListObject = {
    ...
    cuphead: ['imgur:6tVdRp3', 'gfycat:MediumWindingChrysomelid', 'gfycat:ElderlySecretCicada', 'gfycat:MeagerVengefulGrison', 'gfycat:QuestionableColorfulBoilweevil', 'gfycat:ThirstyDizzyCreature', 'gfycat:LinearInsistentCooter'],
    ...
    grandTheftAutoV: ['imgur:uNk5woD', 'gfycat:ForsakenNervousCorydorascatfish', 'gfycat:FarWhimsicalCivet', 'imgur:xuxS3DN', 'gfycat:SimilarOpulentAnemone', 'gfycat:PepperySentimentalGraywolf', 'gfycat:SnappyAppropriateAustraliancurlew', 'imgur:0qnfTk9', 'gfycat:DirectMassiveHawaiianmonkseal', 'imgur:YSo4hkD', 'gfycat:UnknownSparseHoneyeater', 'gfycat:FancyThinHorse', 'imgur:4iVHDZk', 'imgur:eF5Yt8H', 'gfycat:FrayedGoldenGorilla', 'imgur:vWhHAgV', 'gfycat:HarmlessQuestionableAnura', 'gfycat:EnchantedWindingAegeancat', 'gfycat:FlawlessThinInexpectatumpleco', 'imgur:GaBLx9X', 'imgur:ZOANMrO', 'gfycat:ConsciousJollyChrysalis', 'imgur:EOAYAsT', 'gfycat:TameGrotesqueHarpyeagle', 'imgur:b7EMEYu', 'imgur:qmtPDEq', 'gfycat:DefiniteFearlessCobra', 'imgur:4XYMSLy', 'imgur:9xKQTu7', 'gfycat:PowerfulSecondArcticwolf', 'imgur:J0s8Ks6', 'imgur:UNvPoNC', 'imgur:IOVbtql', 'imgur:qclx6PM', 'imgur:K1AuBC5', 'imgur:oGLtuPr', 'imgur